//
// Time-stamp: <2021-11-23 10:12:30 stefan>
//
...
namespace Kartotek.Controllers {
	...
	private readonly ILogger<LandController> loggdest;
	...
	/// <summary>
	/// kreator för LandController
	/// </summary>
	public LandController ( ILogger<LandController> loggdest,
	...
	/// bilden med:
	///   sökformulär
	///   formulär för att addera ett land i registret
	///   enbart en platsmarkör för (i AJAX:versionen)
	///       en sökväljare
	///       detaljer för ett visst kort
	///       listan av länder (vymodell.utdraget)
